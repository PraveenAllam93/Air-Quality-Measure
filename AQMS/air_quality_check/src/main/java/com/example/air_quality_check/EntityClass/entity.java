...
public class entity {
    ...
    public entity(int id, int floor, double  o2_level , double co2_level ,double so2_level ,double co_level , double c_level, String air_quality_level ) {
        this.id = id;
        this.floor = floor;
    ...
    //  config, memory usage,  for looping, springboot best pracrices.
