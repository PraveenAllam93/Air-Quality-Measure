...
class AirQualityCheckApplicationTests {
	...
	public void testSetGetId(){
		...
		testEntity.setId(69);
		assertEquals(69,testEntity.getId());
	}
	...
	public void testConstructedEntity() {
		entity testEntity = new entity(2,3,1000,400,200,300,200, "need to check airQuality");
		assertEquals(2,testEntity.getId());
		assertEquals(3,testEntity.getFloor());
	...
	public void testAirQuality() {
		...
		entity testEntity1 = new entity(1,3,1000,400,200,300,200, "need to check airQuality");
		entity testEntity2 = new entity(2,2,893,173,145,100,161, "need to check airQuality");
		entity testEntity3 = new entity(3,2,439,165,146,168,146, "need to check airQuality");
		entity testEntity4 = new entity(4,1,128,112,129,126,133, "need to check airQuality");
		entity testEntity5 = new entity(5,3,265,81,182,76,152, "need to check airQuality");
		entity testEntity6 = new entity(6,3,336,112,131,104,94, "need to check airQuality");
